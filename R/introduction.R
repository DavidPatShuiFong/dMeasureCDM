...
steps_introduction_df <- function(element_name) {
  steps_df <-
    data.frame(element = as.character(NA),
               intro = c(paste(shiny::tags$h4("GPstat! Chronic Disease Management (CDM)"),
                               shiny::br(),
    ...
    rbind(data.frame(element = element_name,
                     intro = c(paste(shiny::tags$h4("Chronic Disease Management (CDM) view"),
                                     shiny::br(),
    ...
    rbind(data.frame(element = element_name,
                     intro = c(paste(shiny::tags$h4("CDM items shown"),
                                     shiny::br(),
